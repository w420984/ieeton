...
public class ConcurrentLRUHashMap<K, V> extends AbstractMap<K, V> implements
    ...
    final class WriteThroughEntry implements Map.Entry<K, V>, Serializable {
        ...
        public WriteThroughEntry(K theKey, V theValue) {
            key = theKey;
            value = theValue;
        }
         ...
         */
        public WriteThroughEntry(Map.Entry<? extends K, ? extends V> copyFrom) {
            key = copyFrom.getKey();
        ...
        public V setValue( V object ) {
            ...
            V v = value;
            value = object;
            ConcurrentLRUHashMap.this.put(getKey(), object);
            return v;
        }
