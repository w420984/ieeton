    ...
    public void setButtonTypeAndInfo(String left, String middle, String right) {
        ...
        if (TextUtils.isEmpty(left)) {
            ...
            if (left.equalsIgnoreCase(r.getString(R.string.back))) {
                leftButton.setImageResource(R.drawable.back_blue);
        ...
        if (TextUtils.isEmpty(right)) {
            ...
            if (right.equalsIgnoreCase(r.getString(R.string.search))) {
            	rightButton.setVisibility(View.GONE);
            	rightImage.setVisibility(View.VISIBLE);
            	rightImage.setImageResource(R.drawable.search_icon);
