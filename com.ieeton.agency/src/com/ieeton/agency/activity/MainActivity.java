...
import com.ieeton.agency.db.InviteMessgeDao;
import com.ieeton.agency.db.UserDao;
import com.ieeton.agency.domain.InviteMessage;
import com.ieeton.agency.domain.User;
import com.ieeton.agency.domain.InviteMessage.InviteMesageStatus;
...
public class MainActivity extends FragmentActivity {
	...
	public static final int INPUT_CHAT_HISTORY = 0;
	public static final int INPUT_DISCOVER = 1;
	public static final int INPUT_CONTACTLIST = 2;
...
//		registerReceiver(offlineMessageReceiver, offlineMessageIntentFilter);
	...
	protected void onActivityResult(int arg0, int arg1, Intent arg2) {
		fragments[currentTabIndex].onActivityResult(arg0, arg1, arg2);
	...
	private void initView() {
		...
		fragments = new Fragment[] { chatHistoryFragment, discoveryFragment, contactListFragment, myProfileFragment };
...
//	};
	...
	private class MyContactListener implements EMContactListener {
		...
		public void onContactAdded(List<String> usernameList) {
			...
			// 刷新ui
//			if (currentTabIndex == INPUT_CONTACTLIST)
...
//					chatHistoryFragment.errorText.setText("当前网络不可用，请检查网络设置");
	...
	protected void onResume() {
		...
		if (intent != null){
			int index = intent.getIntExtra(INPUT_INDEX, INPUT_CHAT_HISTORY);
