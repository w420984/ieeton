...
import com.ieeton.agency.db.DbOpenHelper;
...
import com.ieeton.agency.location.IeetonLocationListener;
import com.ieeton.agency.models.ServerHostData;
import com.ieeton.agency.net.NetEngine;
import com.ieeton.agency.receiver.VoiceCallReceiver;
...
public class DemoApplication extends Application {
	...
	public static String mLoginType = "mobile";
	...
	private IeetonLocationListener mIeetonLocationListener = new IeetonLocationListener() {
		@Override
		public void onLocationStart() {}
		
		@Override
		public void onLocationFinish(IeetonLocation ieetonLocation) {
			if(ieetonLocation == null){
				Log.v("sereinli", "onLocationFinish:null");
				return;
			}

			mIeetonLocation = ieetonLocation;
			Log.v("sereinli","Application lon:"+ieetonLocation.getLongtitude() + " lat:"+ ieetonLocation.getLatitude());
			Intent successIntent = new Intent(Constants.LOCATION_FINISH_ACTION);
			sendBroadcast(successIntent);
		}
	};

	class GetDomainUrlsTask extends AsyncTask<Void, Void, ServerHostData>{
		...
		protected ServerHostData doInBackground(Void... arg0) {
			...
			try {
				...
				if(!object.getBoolean("error")){
					...
					ServerHostData host = new ServerHostData(json_data);
		...
		protected void onPostExecute(ServerHostData result) {
			if (result == null || result.equals("")){
				mServerHostData = null;
				return;
			}
			mServerHostData = result;
		}
	}
...
//				}
	...
	public void logout() {
		...
		Utils.setMyUid(this, "");
		Utils.setMyLoginName(this, "");
		Utils.setPassport(this, "");
	}
