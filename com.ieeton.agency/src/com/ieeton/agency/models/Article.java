...
public class Article implements Serializable {
	...
	public ChatUser getPublisherInfo(){
		return mPublisher;
	}
	...
	public Article(JSONObject obj){
		...
		mSummaryPicUrl = obj.optString("poster");
		...
		mIsFavorited = obj.optInt("isFavored");
		
		mExternalUrl = obj.optString("externalUrl");
		
		try {
			JSONObject json_data = obj.getJSONObject("publishUser");
			mPublisher = new ChatUser(null, json_data);
